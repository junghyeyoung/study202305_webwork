   ...
   <div class="container" id="app">
      ...
      <form action="signup.jsp" method="post" id="signupForm">
         ...
         <div>
            ...
            <input @input="onPwdInput" v-bind="{'is-valid':isPwdValid, 'is-invalid':!isPwdValid && isPwdDirty}" v-model="pwd" class="form-control" type="password" name="pwd" id="pwd"/>
            <small class="form-text text-muted">특수 문자를 하나 이상 조합하세요.</small>
            <div class="invalid-feedback">비밀 번호를 확인 하세요</div>
         </div>
         <div>
            <label class="control-label" for="pwd2">비밀번호 확인</label>
            <input @input="onPwdInput" v-model="pwd2" class="form-control" type="password" name="pwd2" id="pwd2"/>
         </div>
